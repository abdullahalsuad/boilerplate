...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f9fafb] p-4">
      <div className="w-full max-w-md bg-white rounded-2xl border border-[#e5e7eb] shadow-xl p-8 space-y-6 animate-in fade-in zoom-in duration-500">
        <div className="text-center space-y-2">
          ...
          <p className="text-[#6b7280] ">
            Start your ethical wealth building journey
          </p>
        </div>
